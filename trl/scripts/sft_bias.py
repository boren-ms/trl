...
class SFTScriptArguments:
    ...
    update_encoder: bool = field(
        default=False,
        metadata={"help": "Whether to update the encoder during training."},
    )
    new_lora: bool = field(
        default=False,
...
def make_parser(subparsers: argparse._SubParsersAction = None):
    """Create the argument parser for the SFT script."""
    dataclass_types = (SFTScriptArguments, SFTConfig)
