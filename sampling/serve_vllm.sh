...
# model_path=${HOME}/data/hf_models/Phi-4-7b-ASR-merged
# model_path=${HOME}/data/hf_models/Phi-4-multimodal-instruct
# model_path=${HOME}/data/hf_models/phi4_mm_bias_merged
# use sampling/merge_hf_lora.py to merge lora weights into the model.
model_path=${HOME}/data/hf_models/phi-libri_ft_m1000_p8_new-QpHq/5000_hf_merged
