...
"""
GRPO training script for phi4 multi-modality (vision-language) models.

This script adapts the GRPO training approach for vision-language models,
specifically designed for phi4 multi-modal models with bias considerations.
